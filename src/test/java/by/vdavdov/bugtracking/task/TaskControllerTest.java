...
import by.vdavdov.AbstractControllerTest;
...
import static by.vdavdov.bugtracking.task.TaskController.REST_URL;
import static by.vdavdov.bugtracking.task.TaskService.CANNOT_ASSIGN;
import static by.vdavdov.bugtracking.task.TaskService.CANNOT_UN_ASSIGN;
import static by.vdavdov.bugtracking.task.TaskTestData.NOT_FOUND;
import static by.vdavdov.bugtracking.task.TaskTestData.*;
import static by.vdavdov.common.util.JsonUtil.writeValue;
import static by.vdavdov.login.internal.web.UserTestData.*;
